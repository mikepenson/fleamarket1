...
<div class="wrapper clearfix" style="background-color: #ccffff;height:330px;">
<form title="添加商品" id="ff" method="post" enctype="multipart/form-data">
	...
	<div>
		<label>希望价格*:</label> <input type="text" name="price" />
	</div>
	<div>
	...
	<div>
		<a id="submit" href="#" class="easyui-linkbutton">立即求购</a> 
	</div>
